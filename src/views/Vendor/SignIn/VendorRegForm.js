...
const VendorRegForm = (props) => {
  ...
  const Register = (event) => {
    ...
    postData("http://localhost:3000/api/auth/sellerSignup", obj).then(
      (response) => {
        setDiagStatus(true);
  ...
  return (
    <>
    <Header {...props} />
    <div style={{ paddingTop:"20px",paddingBottom:"20px", textAlign: "-webkit-center" }}>
      <form
        onSubmit={Register}
